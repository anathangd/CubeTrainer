...
struct PLLRecognitionAbridgedCases {
    static let cases: [Algorithm] = [
        Algorithm(name: "oneblockoutside1", algorithm: "V: different block on outside, mostly opp", note: ""),
        Algorithm(name: "oneblockoutside5", algorithm: "(U) V mirrored: different block on outside, mostly opp", note: ""),
        Algorithm(name: "oneblockinside1", algorithm: "Y mirrored: block on the inside different corners", note: ""),
        ...
        Algorithm(name: "noblocksnochecker1", algorithm: "E: no blocks, no checker in checker", note: ""),
        ...
        Algorithm(name: "outerblockleftnotcheckered1", algorithm: "Gc: block outside, adj corner, adj in headlights", note: ""),
        Algorithm(name: "inneradjleft1", algorithm: "Ga: inner block, checkers with adj corner", note: ""),
        ...
        Algorithm(name: "outerrightopp1", algorithm: "Gb: outer block on right, checkers with opp corner", note: ""),
        Algorithm(name: "outerleftopp1", algorithm: "(U) Gd: outer block on left, checkers with opp corner", note: ""),
        Algorithm(name: "outerleftoppnochecker1", algorithm: "Aa: outer block on left, no checker, opp corner", note: ""),
        ...
        Algorithm(name: "outerleftadjnochecker1", algorithm: "T: outer block on left, no checker, adj corner", note: ""),
        ...
        Algorithm(name: "oppinheadright1", algorithm: "Gd: opp in headlights, no other pattern", note: ""),
        Algorithm(name: "adjinheadleft1", algorithm: "Rb: full checker minus outer right", note: ""),
        ...
        Algorithm(name: "3colorcheckermiddle5", algorithm: "F: checkers in middle, outer corners same (look for outer opp pair)", note: ""),
        ...
        Algorithm(name: "1outerright1inner1", algorithm: "Jb: two blocks, outer on right, more adj", note: ""),
        Algorithm(name: "outerblockrightcheckered1", algorithm: "(U) Ab mirrored: outer block on right, checkers", note: ""),
        Algorithm(name: "outerblockleftcheckered1", algorithm: "Ab: outer block left, checkers", note: ""),
        ...
        Algorithm(name: "no3x1atleast1oppright1", algorithm: "It’s Ua when an opposite edge color is on the right", note: ""),
        ...
        Algorithm(name: "no3x1nooppcheckerright1", algorithm: "It’s Ub when a checker pattern is only on the right", note: ""),
    ]
}
