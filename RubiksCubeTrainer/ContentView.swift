    ...
    init() {
        ...
        categories = [
            ...
            Category(name: "PLL Recognition", algorithms: [
                ...
                Algorithm(name: "oneblockinside1", algorithm: "(No rotation, mirrored) It’s Y when there’s a block on the inside", note: ""),
                Algorithm(name: "oneblockinside2", algorithm: "(No rotation, mirrored) It’s Y when there’s a block on the inside", note: ""),
                Algorithm(name: "oneblockinside3", algorithm: "(No rotation, mirrored) It’s Y when there’s a block on the inside", note: ""),
                Algorithm(name: "oneblockinside4", algorithm: "(No rotation, mirrored) It’s Y when there’s a block on the inside", note: ""),
                Algorithm(name: "oneblockinside5", algorithm: "(U) It’s Y when there’s a block on the inside", note: ""),
                Algorithm(name: "oneblockinside6", algorithm: "(U) It’s Y when there’s a block on the inside", note: ""),
                Algorithm(name: "oneblockinside7", algorithm: "(U) It’s Y when there’s a block on the inside", note: ""),
                Algorithm(name: "oneblockinside8", algorithm: "(U) It’s Y when there’s a block on the inside", note: ""),
                
                // Category 3: No Blocks
                Algorithm(name: "noblockscheckerinside1", algorithm: "(U') It’s V when there’s a checker pattern on the inside", note: ""),
                Algorithm(name: "noblockscheckerinside2", algorithm: "(U') It’s V when there’s a checker pattern on the inside", note: ""),
                Algorithm(name: "noblockscheckerinside3", algorithm: "(U') It’s V when there’s a checker pattern on the inside", note: ""),
                Algorithm(name: "noblockscheckerinside4", algorithm: "(U') It’s V when there’s a checker pattern on the inside", note: ""),
                ...
                Algorithm(name: "noblocksnochecker1", algorithm: "(No rotation) It’s E when there are no blocks and no checker pattern. Look for the side that matches the center", note: ""),
                Algorithm(name: "noblocksnochecker2", algorithm: "(No rotation) It’s E when there are no blocks and no checker pattern. Look for the side that matches the center", note: ""),
                Algorithm(name: "noblocksnochecker3", algorithm: "(No rotation) It’s E when there are no blocks and no checker pattern. Look for the side that matches the center", note: ""),
                Algorithm(name: "noblocksnochecker4", algorithm: "(No rotation) It’s E when there are no blocks and no checker pattern. Look for the side that matches the center", note: ""),
                Algorithm(name: "noblocksnochecker5", algorithm: "(U) It’s E when there are no blocks and no checker pattern. Look for the side that matches the center", note: ""),
                Algorithm(name: "noblocksnochecker6", algorithm: "(U) It’s E when there are no blocks and no checker pattern. Look for the side that matches the center", note: ""),
                Algorithm(name: "noblocksnochecker7", algorithm: "(U) It’s E when there are no blocks and no checker pattern. Look for the side that matches the center", note: ""),
                Algorithm(name: "noblocksnochecker8", algorithm: "(U) It’s E when there are no blocks and no checker pattern. Look for the side that matches the center", note: ""),
                ...
                Algorithm(name: "inneroppleft1", algorithm: "(No rotation) It’s Gb when the inner block is on the left and the corner beside the block is opposite", note: ""),
                Algorithm(name: "inneroppleft2", algorithm: "(No rotation) It’s Gb when the inner block is on the left and the corner beside the block is opposite", note: ""),
                Algorithm(name: "inneroppleft3", algorithm: "(No rotation) It’s Gb when the inner block is on the left and the corner beside the block is opposite", note: ""),
                Algorithm(name: "inneroppleft4", algorithm: "(No rotation) It’s Gb when the inner block is on the left and the corner beside the block is opposite", note: ""),
                
                Algorithm(name: "inneroppright1", algorithm: "(U) It’s Gd when the inner block is on the right and the corner beside the block is opposite", note: ""),
                Algorithm(name: "inneroppright2", algorithm: "(U) It’s Gd when the inner block is on the right and the corner beside the block is opposite", note: ""),
                Algorithm(name: "inneroppright3", algorithm: "(U) It’s Gd when the inner block is on the right and the corner beside the block is opposite", note: ""),
                Algorithm(name: "inneroppright4", algorithm: "(U) It’s Gd when the inner block is on the right and the corner beside the block is opposite", note: ""),
                ...
                Algorithm(name: "outerleftadjchecker1", algorithm: "(U') It’s Ra when the block is on the left and it checkers in the middle (mirror of Gb)", note: ""),
                Algorithm(name: "outerleftadjchecker2", algorithm: "(U') It’s Ra when the block is on the left and it checkers in the middle (mirror of Gb)", note: ""),
                Algorithm(name: "outerleftadjchecker3", algorithm: "(U') It’s Ra when the block is on the left and it checkers in the middle (mirror of Gb)", note: ""),
                Algorithm(name: "outerleftadjchecker4", algorithm: "(U') It’s Ra when the block is on the left and it checkers in the middle (mirror of Gb)", note: ""),
                
                Algorithm(name: "outerrightadjchecker1", algorithm: "(U2) It’s Rb when the block is on the right and it checkers in the middle (mirror of Gd)", note: ""),
                Algorithm(name: "outerrightadjchecker2", algorithm: "(U2) It’s Rb when the block is on the right and it checkers in the middle (mirror of Gd)", note: ""),
                Algorithm(name: "outerrightadjchecker3", algorithm: "(U2) It’s Rb when the block is on the right and it checkers in the middle (mirror of Gd)", note: ""),
                Algorithm(name: "outerrightadjchecker4", algorithm: "(U2) It’s Rb when the block is on the right and it checkers in the middle (mirror of Gd)", note: ""),
                
                Algorithm(name: "outerlefttadjnochecker1", algorithm: "(No rotation) It’s T when the block is on the left and it doesn't checker in the middle (and it's an adjacent corner)", note: ""),
                Algorithm(name: "outerlefttadjnochecker2", algorithm: "(No rotation) It’s T when the block is on the left and it doesn't checker in the middle (and it's an adjacent corner)", note: ""),
                Algorithm(name: "outerlefttadjnochecker3", algorithm: "(No rotation) It’s T when the block is on the left and it doesn't checker in the middle (and it's an adjacent corner)", note: ""),
                Algorithm(name: "outerlefttadjnochecker4", algorithm: "(No rotation) It’s T when the block is on the left and it doesn't checker in the middle (and it's an adjacent corner)", note: ""),
                
                Algorithm(name: "outerrighttadjnochecker1", algorithm: "(U) It’s T mirrored when the block is on the right and it doesn't checker in the middle (and it's an adjacent corner)", note: ""),
                Algorithm(name: "outerrighttadjnochecker2", algorithm: "(U) It’s T mirrored when the block is on the right and it doesn't checker in the middle (and it's an adjacent corner)", note: ""),
                Algorithm(name: "outerrighttadjnochecker3", algorithm: "(U) It’s T mirrored when the block is on the right and it doesn't checker in the middle (and it's an adjacent corner)", note: ""),
                Algorithm(name: "outerrighttadjnochecker4", algorithm: "(U) It’s T mirrored when the block is on the right and it doesn't checker in the middle (and it's an adjacent corner)", note: ""),
                ...
                Algorithm(name: "3colorcheckermiddle1", algorithm: "(U') It's F when only three unique colors are visible are there's a checker pattern in the middle", note: ""),
                Algorithm(name: "3colorcheckermiddle2", algorithm: "(U') It's F when only three unique colors are visible are there's a checker pattern in the middle", note: ""),
                Algorithm(name: "3colorcheckermiddle3", algorithm: "(U') It's F when only three unique colors are visible are there's a checker pattern in the middle", note: ""),
                Algorithm(name: "3colorcheckermiddle4", algorithm: "(U') It's F when only three unique colors are visible are there's a checker pattern in the middle", note: ""),
                
                Algorithm(name: "oppoutercornerright1", algorithm: "(U') It’s Ga when an opposite outer corner is on the right", note: ""),
                Algorithm(name: "oppoutercornerright2", algorithm: "(U') It’s Ga when an opposite outer corner is on the right", note: ""),
                Algorithm(name: "oppoutercornerright3", algorithm: "(U') It’s Ga when an opposite outer corner is on the right", note: ""),
                Algorithm(name: "oppoutercornerright4", algorithm: "(U') It’s Ga when an opposite outer corner is on the right", note: ""),
                
                Algorithm(name: "oppoutercornerleft1", algorithm: "(U2) It’s Gc when an opposite outer corner is on the left", note: ""),
                Algorithm(name: "oppoutercornerleft2", algorithm: "(U2) It’s Gc when an opposite outer corner is on the left", note: ""),
                Algorithm(name: "oppoutercornerleft3", algorithm: "(U2) It’s Gc when an opposite outer corner is on the left", note: ""),
                Algorithm(name: "oppoutercornerleft4", algorithm: "(U2) It’s Gc when an opposite outer corner is on the left", note: ""),
                
                Algorithm(name: "oppinnercornerright1", algorithm: "(U2) It’s Ra when an opposite inner corner is on the right", note: ""),
                Algorithm(name: "oppinnercornerright2", algorithm: "(U2) It’s Ra when an opposite inner corner is on the right", note: ""),
                Algorithm(name: "oppinnercornerright3", algorithm: "(U2) It’s Ra when an opposite inner corner is on the right", note: ""),
                Algorithm(name: "oppinnercornerright4", algorithm: "(U2) It’s Ra when an opposite inner corner is on the right", note: ""),
                
                Algorithm(name: "oppinnercornerleft1", algorithm: "(U') It’s Rb when an opposite inner corner is on the left", note: ""),
                Algorithm(name: "oppinnercornerleft2", algorithm: "(U') It’s Rb when an opposite inner corner is on the left", note: ""),
                Algorithm(name: "oppinnercornerleft3", algorithm: "(U') It’s Rb when an opposite inner corner is on the left", note: ""),
                Algorithm(name: "oppinnercornerleft4", algorithm: "(U') It’s Rb when an opposite inner corner is on the left", note: ""),
            ])
        ]
    }
    var body: some View {
                        ...
                        VStack {
                            ...
                            if let category = categories.first(where: { $0.name == "PLL Recognition" }),
                               !category.algorithms.isEmpty {
                                NavigationLink(destination: IndividualCategoryView(category: category)) {
                                    Text("PLL Recognition (\(category.algorithms.count))")
                                        .capsuleButtonStyle()
                                }
                            }
                            
                            NavigationLink(destination: ListView(category: categories.first { $0.name == "PLL Recognition" }!)) {
                                Text("PLL Recognition List")
                                    .capsuleButtonStyle()
                            }
