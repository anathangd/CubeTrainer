...
struct OLLRecognitionCases {
    static let cases: [Algorithm] = [
        ...
        // other 8
        Algorithm(name: "otherrec29", algorithm: "(No rotation) other 8", note: "", answer: "other 8"),
        Algorithm(name: "otherrec30", algorithm: "(U) other 8", note: "", answer: "other 8"),
        Algorithm(name: "otherrec31", algorithm: "(U2) other 8", note: "", answer: "other 8"),
        Algorithm(name: "otherrec32", algorithm: "(U') other 8", note: "", answer: "other 8"),
        // other 9
        Algorithm(name: "otherrec33", algorithm: "(No rotation) other 9", note: "", answer: "other 9"),
        Algorithm(name: "otherrec34", algorithm: "(U) other 9", note: "", answer: "other 9"),
        Algorithm(name: "otherrec35", algorithm: "(U2) other 9", note: "", answer: "other 9"),
        Algorithm(name: "otherrec36", algorithm: "(U') other 9", note: "", answer: "other 9"),
        // other 10
        Algorithm(name: "otherrec37", algorithm: "(No rotation) other 10", note: "", answer: "other 10"),
        Algorithm(name: "otherrec38", algorithm: "(U) other 10", note: "", answer: "other 10"),
        Algorithm(name: "otherrec39", algorithm: "(U2) other 10", note: "", answer: "other 10"),
        Algorithm(name: "otherrec40", algorithm: "(U') other 10", note: "", answer: "other 10"),
    ]
}
