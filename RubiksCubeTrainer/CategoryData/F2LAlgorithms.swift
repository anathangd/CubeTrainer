...
struct F2LAlgorithms {
    static let algorithms: [Algorithm] = [
        ...
        Algorithm(name: "corner edge top 5", algorithm: "d R' U2' R U' f R f'", note: "", hasVid: true),
        ...
        Algorithm(name: "corner edge top 9", algorithm: "d R' U2' R U R' U2' R", note: "", hasVid: true),
        Algorithm(name: "corner edge top 10", algorithm: "(U' R U2 R') (U' R U2 R')", note: "", hasVid: true),
        Algorithm(name: "corner edge top 11", algorithm: "d R' U' R U R' U2' R", note: "", hasVid: true),
        ...
        Algorithm(name: "corner up edge top 4", algorithm: "d' L' U2 L U' L' U L", note: "", hasVid: true),
        Algorithm(name: "corner up edge top 5", algorithm: "U2 (R U R' U) (R U' R')", note: "", hasVid: true),
        Algorithm(name: "corner up edge top 6", algorithm: "d' U' L' U' L U' L' U L)", note: "", hasVid: true),
