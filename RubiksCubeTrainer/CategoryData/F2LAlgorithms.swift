...
struct F2LAlgorithms {
    static let algorithms: [Algorithm] = [
        ...
        Algorithm(name: "corner edge top 4", algorithm: "(U' R U' R') d (R' U' R)", note: "", hasVid: true, roofpig: true),
        Algorithm(name: "corner edge top 5", algorithm: "d (R' U2' R U') (f R f')", note: "", hasVid: true, roofpig: true),
        Algorithm(name: "corner edge top 6", algorithm: "(U' R U2' R') d (R' U' R)", note: "", hasVid: true, roofpig: true),
        Algorithm(name: "corner edge top 7", algorithm: "(R U' R' U) d (R' U' R)", note: "", hasVid: true, roofpig: true),
        ...
        Algorithm(name: "corner edge top 10", algorithm: "(U' R U2' R') (U' R U2' R')", note: "", hasVid: true, roofpig: true),
        ...
        Algorithm(name: "corner top edge middle 4", algorithm: "(U' R U R') d (R' U' R)", note: "", hasVid: true, roofpig: true),
        Algorithm(name: "corner top edge middle 5", algorithm: "(R U' R') d (R' U R)", note: "", hasVid: true, roofpig: true),
        Algorithm(name: "corner top edge middle 6", algorithm: "(R U R' U') (R U R' U') (R U R')", note: "", hasVid: true, roofpig: true),
        
        Algorithm(name: "corner bottom edge top 1", algorithm: "(U R U' R') d' (L' U L)", note: "", hasVid: true, roofpig: true),
        ...
        Algorithm(name: "corner bottom edge middle 3", algorithm: "(R U R') (U' R U' R' U) d (R' U' R)", note: "", hasVid: true, roofpig: true),
        Algorithm(name: "corner bottom edge middle 4", algorithm: "(R U' R') d (R' U' R) (U' R' U' R)", note: "", hasVid: true, roofpig: true),
