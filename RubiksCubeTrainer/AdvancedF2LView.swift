...
struct AdvancedF2LView: View {
    ...
    let categories: [Category] = [
        ...
        Category(name: "White up", algorithms: [
           ...
           Algorithm(name: "white up 8", algorithm: "F R' U R F'", note: "", roofpig: true, setupMoves: "y", type: "AdvF2L")
           ]),
        // done
        ...
        Category(name: "Wrong corner", algorithms: [
            ...
            Algorithm(name: "wrong corner 6", algorithm: "U' (R U R') y' (R U R')", note: "", hasVid: true, roofpig: true, setupMoves: "y", type: "AdvF2L")
        ]),
        // done
        Category(name: "Corner left", algorithms: [
            ...
            Algorithm(name: "corner left 3", algorithm: "y U (L' U' L) y (L' U' L)", note: "", hasVid: true, roofpig: true, setupMoves: "y'", type: "AdvF2L"),
        ...
        Category(name: "Corner back", algorithms: [
            ...
            Algorithm(name: "corner back 6", algorithm: "y (L' U L) (R' U2' R)", note: "", hasVid: true, roofpig: true, setupMoves: "y2", type: "AdvF2L")
        ]),
        // done
        ...
        Category(name: "Extra", algorithms: [
            ...
            Algorithm(name: "extra 9", algorithm: "(R U' R' U') y R U' R' d R' U R", note: "", hasVid: true, roofpig: true, setupMoves: "y'", type: "AdvF2L"),
            Algorithm(name: "extra 10", algorithm: "y (L' U L U) y' L' U L d' L U' L'", note: "", hasVid: true, roofpig: true, setupMoves: "y", type: "AdvF2L"),
            Algorithm(name: "extra 11", algorithm: "(R U R' U2') y R U' R' d R' U R", note: "", hasVid: true, roofpig: true, setupMoves: "y'", type: "AdvF2L"),
            Algorithm(name: "extra 12", algorithm: "y (L' U' L U2') y' L' U L d' L U' L'", note: "", hasVid: true, roofpig: true, setupMoves: "y", type: "AdvF2L"),
            Algorithm(name: "extra 13", algorithm: "(R U' R2' U' R) d' R U R'", note: "", hasVid: true, roofpig: true, setupMoves: "y'", type: "AdvF2L"),
            Algorithm(name: "extra 14", algorithm: "y (L' U L2 U L') d L' U' L", note: "", hasVid: true, roofpig: true, setupMoves: "y", type: "AdvF2L"),
